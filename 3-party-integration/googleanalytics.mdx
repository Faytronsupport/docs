---
title: "Integrate  Faytron with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  Faytron."
---

#### **Integration of Google Analytics with  Faytron**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  Faytron chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  Faytron:

**Step 1: Log in to  Faytron**

1. Navigate to your [ Faytron account](https://www. Faytron.com/).
...
To connect Google Analytics to your  Faytron account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  Faytron**

1. Go back to the  Faytron integration page where you clicked **Connect** for Google Analytics.
