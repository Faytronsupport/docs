---
title: "Integrate  Faytron with Kylas CRM"
description: "Integrating  Faytron with Kylas CRM allows seamless lead capturing and management. Follow these detailed steps to complete the integration:"
---

### **Why use Kylas CRM?**

 Faytron integrates with Kylas CRM to streamline lead generation, customer engagement, and sales management. By combining  Faytron’s AI-powered chatbot with Kylas CRM’s customer relationship tools, businesses can automate lead capture, qualify prospects, and sync real-time customer interactions directly into the CRM, allowing sales teams to prioritize and follow up more effectively, improving conversion rates and sales efficiency.
...
- **Personalized Engagement:** Leverage customer data from Kylas CRM to provide tailored and relevant interactions via  Faytron.
...
#### **Step 1: Log in to  Faytron**

1. Access your  Faytron account by logging in.
2. \
...
#### **Step 3: Configure the API Token in  Faytron**

1. Return to the  Faytron dashboard.
...
1. After the integration is connected, set up the lead parameters and questions in  Faytron (e.g., Name, Phone Number, Email).
2. \
...
3. \
   You will see that the lead captured through  Faytron has been successfully created in the Contacts section of Kylas CRM.

By following these steps, you can effectively integrate  Faytron with Kylas CRM and streamline your lead management process.
