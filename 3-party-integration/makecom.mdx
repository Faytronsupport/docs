---
title: "Integrate  Faytron with Make.com"
description: "This page contains step by step guide on how you can integrate the make.com with  Faytron."
---

You can connect  Faytron with [Make.com](http://Make.com) to automate the lead details.

<Info>
  The following **TRIGGERS** can be set in  Faytron:

  1. Watch New Contact Created -\> This will be trigger when a new contact is created on  Faytron platform.
  2. Watch New Incoming Message -\> This will be triggered when a new incoming message is received on  Faytron platform.
  3. Watch New WhatsApp Order placed -\> This will be triggered when a new order on Whatsapp bot will be placed.
</Info>

<Info>
  The following **ACTIONS** can be used in  Faytron:

  1. Add a contact -\> This will add a contact to your  Faytron Account
...
### **How to use  Faytron as Trigger**

 1. Log in to your  Faytron account.
 ...
 8. \
    You can now click on the "\+" icon in canvas and search for  Faytron in the search bar.
 9. Select the trigger events for your bot to initiate the action. Here we have selected "Watch New Contact Created"

    <Info>
      Procedure for setting up other  Faytron Triggers are same
    </Info>
10. \
...
- Then enter the API Key from your  Faytron account. (Follow instructions available below)
- Select the platform of the bot you are integrating with.
- Then paste the BotID which you copied earlier from [Make.com](http://Make.com) third party integration in  Faytron

Then click on "Save" button and your Trigger is set.

**You can get API Key from the "Developers" section in  Faytron. Then click on Access Token and copy the same.**

12. \
    Then you have to add an action which will take place once event trigger takes place.
13. Click on the "\+" icon next to  Faytron Bubble to add an action. Here we have used Google Sheets as action.
14. \
...
19. Then go to  Faytron and select the bot which you were integrating with [Make.com](http://Make.com)
...
<Info>
  Remember that the contact info entered should not be available on  Faytron platform previously. As it will be considered as revisit lead and will not be triggered by  Faytron app in Google sheet or any other app which is used as an action.
</Info>

### **How to use Action in  Faytron**
 ...
 7. Search for  Faytron and select an Action event which will take place after receiving the trigger.
 8. \
    Set up connection by providing the **API key and BotID **from  Faytron as explained above.
...
You have successfully connected  Faytron as action. Once a trigger takes place your bot will follow the action.
