---
title: "Integrate  Faytron with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  Faytron, you will need:

- A ** Faytron** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  Faytron to collect payments via Razorpay.

#### **Step 1: Login to  Faytron and Select WhatsApp Bot**

1. Go to [ Faytron](https://www. Faytron.com/) and log into your account.
...
To connect Razorpay with  Faytron, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  Faytron**
...
4. Go back to  Faytron and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  Faytron bot editor.
2. \
...
Your  Faytron WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   