---
title: "Integrate  Faytron with Twilio"
description: "This page provides a step-by-step guide on integration of  Faytron with Twilio"
---

### **Why use Twilio?**

Integrate Twilio with your  Faytron chatbot to enable seamless SMS and WhatsApp messaging. This allows your chatbot to reach users directly on their phones, improving engagement, outreach, and customer satisfaction. Whether you're sending order updates or automating lead follow-ups, Twilio ensures reliable delivery.
...
- Your  Faytron chatbot is published and assigned to a valid channel.

---

### **Steps to Integrate  Faytron with Twilio:**

#### **Step 1: Going to Integration on  Faytron**

1. Sign into your  Faytron account and choose the chatbot. Go to "Third Party Apps Integrations"
2. \
...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. \
    Copy and paste the same tokens in the  Faytron Applciation.
 ...
 7. \
    ...
    - Set the name as " Faytron".
    - Copy the code in  Faytron Twilio Integration Screen, and paste it in the Request URL box.
 8. \
    This will create a new application.
 9. Click on the application to see the **TwiLM App SID**. Copy the ID over to the  Faytron platform.
10. \
...
14. \
    Copy the same in your  Faytron Account.
15. \
...
17. \
    Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  Faytron.
18. \
...
<AccordionGroup>
  <Accordion title="Does  Faytron offer SMS services with Twilio">
    No,  Faytron only offers Twilio with Voice calling configuration.
  </Accordion>
