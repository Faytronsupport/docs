---
title: "Integrate  Faytron with Zapier"
description: "This page contains the step wise tutorial for the integration of Zoho CRM with  Faytron."
---

### **What is Zapier.**

Zapier is an automation tool which helps making a connecting between apps. You can set  Faytron and apps in zapier as triggers and actions.

---

### **Benifits of using Zapier:**

- **Seamless Automation:** Instantly connect  Faytron with thousands of apps without custom coding.
...
### **Steps to use  Faytron with Zapier**

 1. Log in to your  Faytron account and select a bot you wish to integrate with Zapier.
 ...
 4. Then go to Zapier website.
    ...
    [ Faytron Integrations | Connect Your Apps with ZapierZapier](https://zapier.com/apps/ Faytron/integrations)
 5. Here you can see all the supported Triggers and Actions that are available to be used with  Faytron.
...
11. Select  Faytron from the list as trigger.
12. Then select a trigger event from the list of available events.
13. After that click on "Sign In" to connect  Faytron.
14. \
    When you click on sign in, a pop will be opened to give zapier access to your  Faytron account.
15. Select the platform / bot channel for which you want to use zapier
16. Then enter the API Key which is available in Developers section inside Access Token in  Faytron.
17. Then enter the Bot Id, you can click on "edit" in Zapier Integration Page to get Bot Id for the same.
18. And click "Yes Continue with  Faytron".
...
**Similarly you can use other apps as TRIGGERS and  Faytron as ACTION**
