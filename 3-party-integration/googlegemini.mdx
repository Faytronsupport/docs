---
title: "Integrate  Faytron with Google Gemini"
description: "This page provides an in-depth guide on integrating  Faytron with Google Gemini.
...
The integration of Google Gemini with  Faytron brings cutting-edge generative AI capabilities to your chatbot experience. Gemini, Google’s state-of-the-art multimodal LLM (Large Language Model), enables natural, context-aware, and multi-turn conversations that go beyond standard automation.

This guide outlines the step-by-step process to integrate Google Gemini with  Faytron.
...
#### **Step 3: Add Gemini in  Faytron**

1. Log in to your  Faytron dashboard.
2. Select the "Third-Party Apps Integrations"
3. Search for "Google Gemini"
4. Click on Connect, and enter the API key.

Congratulations\! You have successfully integrated  Faytron with Google Gemini\!
...
<AccordionGroup>
  <Accordion title="Which Gemini models are supported in  Faytron?">
     Faytron currently supports:
  ...
  <Accordion title="Can I use both OpenAI and Gemini models in one  Faytron account?">
