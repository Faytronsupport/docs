...
```
https://api.v7. Faytron.com/whatsapp-automation/wa/templates?apiKey=*API KEY*
```
...
```
curl --location --request GET 'https://api.v7. Faytron.com/whatsapp-automation/wa/templates?apiKey=*API KEY*' \\
