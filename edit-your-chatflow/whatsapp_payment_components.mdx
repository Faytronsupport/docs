...
- Go to your chosen WhatsApp bot, and then click on "Edit Your Chatflow".
  ...
  ![20 Whatsapp Payment Faytron Botpenguin Resource C 1 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_Faytron__botpenguin_resource_c-1.png)
- Select the flow in which you want to include the Payment component into.

  ![20 Whatsapp Payment Faytron Botpenguin Resource C 2 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_Faytron__botpenguin_resource_c-2.png)
- Go to the "Trigger Actions", and then click on "Payments" to add the payments components.

  ![20 Whatsapp Payment Components  Faytron Resource C 3 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-3.png)

\
Fill out the following details to setup you payment methodology and needs:

![20 Whatsapp Payment Components  Faytron Resource C 4 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-4.png)
...
1. To use this component, navigate again to the Flow you want to integrate this component into, and then click on the "WhatsApp Payments" component.
   ...
   ![20 Whatsapp Payment Components  Faytron Resource C 5 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-5.png)
...
- Go to https://business.facebook.com/, and click on the "Search" tab on the left-hand side.
  ...
  ![20 Whatsapp Payment Components  Faytron Resource C 6 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-6.png)
...
- Search for "**WhatsApp Manager**".
  ...
  ![20 Whatsapp Payment Components  Faytron Resource C 6 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-7.png)
- Go to the "Payment Configuration" section of the new screen, near the bottom.
  ...
  ![20 Whatsapp Payment Components  Faytron Resource C 8 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-8.png)
...
- Click on "Add Configuration" on the top-right hand side.
  ...
  ![20 Whatsapp Payment Components  Faytron Resource C 9 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-9.png)
...
- Once you have entered all the details, a new payment configuration will be made, which you can now go back to in  Faytron and configure the "Payment Configuration" section in.

  ![20 Whatsapp Payment Components  Faytron Resource C 10 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__Faytron_resource_c-10.png)

And, you are done\! You have successfully configured the Payments options on your WhatsApp bot.

### **FAQ's:**

Here are some common FAQ's regarding payment components in  Faytron:
