...
To use the  Faytron APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  Faytron Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__Faytron_resource_c-1.png)
...
https://page. Faytron.com/BotId/CustomerId
...
<script id=" Faytron-messenger-widget" src="https://cdn. Faytron.com/ Faytron.js" defer>BotId,CustomerId</script>
...
`PUT` `https://api.v7. Faytron.com/inbox/direct/lead`
...
`GET` `https://api.v7. Faytron.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  Faytron. I am here to help you."
            },
...
If you have any questions, you can look into our repository of FAQs, most likely, you will find your answer here, If not, write us at [support@ Faytron.com](mailto:support@ Faytron.com).