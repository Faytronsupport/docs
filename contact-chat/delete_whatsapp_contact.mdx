...
This API endpoint allows you to update the status of users in your  Faytron application.

**Endpoint URL:** `https://api.v7. Faytron.com/inbox/users/status-update`
...
```
curl 'https://api.v7. Faytron.com/inbox/users/status-update' \
  -X 'PUT' \
